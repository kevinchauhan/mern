...
export class RenameTables1721057809190 implements MigrationInterface {
    name = 'RenameTables1721057809190'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.renameTable('refresTokens', 'refresh_token');
    }
